...
import { oilData } from "../../ddd/constant";
...
export default function OilProducts() {
  ...
  function Search(eo){
    ...
    searchValue ==="" ? setData(oilData) : setData(DataFiltered)
  }
  return (
    <div className="products_pages">
      ...
      <main className="flex">
        <video className="bg_video" autoPlay loop playsInline muted src={require("../../videos/الزيت.mp4")}></video>
        <h1>أحصل علي أجود <span>الزيوت</span> الطبيعة .</h1>
