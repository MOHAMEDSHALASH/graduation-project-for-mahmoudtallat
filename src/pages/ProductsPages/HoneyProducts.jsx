...
export default function HoneyProducts() {
  ...
  const [Data,setData] = useState(honeyData)
  ...
  function Search(eo){
    ...
    searchValue ==="" ? setData(honeyData) : setData(DataFiltered)
  }
  return (
    <div className="products_pages">
      ...
      <main className="flex">
        <video className="bg_video" autoPlay loop playsInline muted src={require("../../videos/العسل.mp4")}></video>
        <h1>تذوق طعم <span>العسل الأصلي</span> من أفضل المناحل.</h1>
